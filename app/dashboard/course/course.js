...
angular.module('NeoLearning.course', ['oitozero.ngSweetAlert'])
.controller('CourseCtrl', ['$scope', '$state', '$stateParams',  '$window', '$filter', 'UserService', 'CourseService', 'SweetAlert', function($scope, $state, $stateParams, $window, $filter, UserService, CourseService, SweetAlert) {
  ...
  // function getUserInCourse(course){
  //   var registeredStudentsNames= [];
  //   var courseStudentAddRequest = CourseService.api('course/'+ course.idCourse +'/user').get();
  //   courseStudentAddRequest.$promise.then(function(result){
  //    if(result.success){
  //       console.log('registeredStudent', result.data.studentCourses);
  //       addedStudents = result.data.studentCourses;
